...
module.exports = {
  ...
  */
  execute: async (client) => {
    ...
    var req = await fetch.default("https://api.infinitybotlist.com/bots/stats", {
      method: "POST",
      headers: {
    ...
    req = await fetch.default(`https://radarbotdirectory.xyz/api/bot/${client.user.id}/stats`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
    ...
    req = await fetch.default(`https://api.voidbots.net/bot/stats/${client.user.id}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
